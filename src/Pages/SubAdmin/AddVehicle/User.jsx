...
try {
  ...
  const response = await axios.put(`http://localhost:3002/api/users/inactive/${id}`, {
...
try {
  // Make an API call to update status for the given user ID
  const response = await axios.put(`http://localhost:3002/api/users/active/${id}`, {
    ...
    selector: (row) => (
      <div>
        ...
        {row.status === 0 ? (
          ...
          <button type="button" className="btn btn-sm btn-danger" onClick={() => updateStatus(row._id)}>
            Inactive
          </button>
        )}
      </div>
...
try {
  // Make an API call to update status for the given user ID
  const response = await axios.put(`http://localhost:3002/api/users/assign_route/${id}`,formData);
  if (response.status === 200) {
    console.log("Status updated successfully!");
    window.location.reload();
  }
    ...
    <div class="dashboard-main-body">
      ...
      <div class="card basic-data-table">
        <div class="card-header bg-primary text-white" style={{padding:".5rem 1rem"}}>
          <div class="row">
            <div class="col-6">
              <h5 class="card-title mb-0 text-light" style={{paddingTop:".6rem !important",marginTop:"2%"}}>Vehicle List</h5>
            </div>
            <div class="col-6">
              <Link to={'/add_user'} class="btn btn-success float-end" >Add Vehicle</Link>
            </div>
          </div>
        </div>
        <div class="card-body">
...
/>
              ...
              <Modal show={show} onHide={handleClose} size='lg'>
                  <Modal.Header closeButton className="bg-info text-light">
                    <Modal.Title className="text-center fade-in"><h6 className='h6 m-0'>E-Rickshaw Details</h6></Modal.Title>
                  </Modal.Header>
                  <Modal.Body className="bg-light">
                    ...
                    <div className={`bg-light`}>
                          ...
                          <div className="col-md-4 d-flex">
                            <Card className="shadow-sm hover-shadow fade-in-left flex-fill">
                              <Card.Header className="bg-primary text-white">
                                <h6 className="text-light card-title m-0">E-Rickshaw Photo</h6>
                              </Card.Header>
                              <Card.Body className="text-center">
                                <Image
                                  src={imageUrl + selectedData.rickshaw_photo}
                                  alt="E-Rickshaw"
                                  width={192}
                                  height={192}
                                />
                          ...
                          <div className="col-md-8 d-flex">
                            <Card className="shadow-sm hover-shadow fade-in-right flex-fill">
                              <Card.Header className="bg-success text-white">
                                <h6 className="h6 text-light card-title m-0"> Vehicle Information &nbsp;({selectedData.e_rickshaw})</h6>
                              </Card.Header>
                              <Card.Body>
                                <div className="row">
                                  <div className="col-md-12">
                                    <p className="d-flex align-items-center">
                                      ...
                                      <strong>E-Rickshaw Number:</strong> &nbsp;{selectedData.e_rickshaw}
                                    </p>
                                  </div>
                                  <div className="col-md-6">
                                    <p className="d-flex align-items-center">
                                      <i className="bi bi-file-text text-success me-2"></i>{" "}
                                      <strong>Chassis:</strong> &nbsp;{selectedData.chassis}
                                    </p>
                                  </div>
                                  <div className="col-md-6">
                                    <p className="d-flex align-items-center">
                                      <i className="bi bi-calendar text-success me-2"></i>{" "}
                                      <strong>Fitness Expiry:</strong> &nbsp;{selectedData.fitness}
                                    </p>
                                  </div>
                                  <div className="col-md-12">
                                  <div className="route-container">
                                    <div className="line"></div>
                                      ...
                                      <div className="stop start-point">
                                        ...
                                        <div className="stop-name">{startPoint}</div>
                                      </div>
                                      ...
                                      <div className="stop end-point">
                                        <div className="stop-marker"></div>
                                        <div className="stop-name">{endPoint}</div>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                        ...
                        <Tabs defaultActiveKey="owner" className="mt-4 custom-tabs fade-in-up">
                        <Tab  eventKey="owner"  title="Owner Details"  className="bg-light">
                          <Card className="shadow-sm hover-shadow mt-3">
                            <Card.Header className="bg-warning text-white">
                              <h6 className='card-title text-light m-0'>Owner Information</h6>
                            </Card.Header>
                            <Card.Body>
                              <div className="row">
                                <div className="col-md-3 text-center">
                                  <Image
                                    src={imageUrl + selectedData.owner_photo}
                                    roundedCircle
                                    alt="Owner"
                                    width={128}
                                    height={128}
                                  ...
                                  <div className="row">
                                    <div className="col-md-6">
                                      <p className="d-flex align-items-center">
                                        ...
                                        <strong>Name:</strong> &nbsp;{selectedData.owner_name}
                                      </p>
                                    </div>
                                    <div className="col-md-6">
                                      <p className="d-flex align-items-center">
                                        <i className="bi bi-telephone text-warning me-2"></i>
                                        <strong>Phone:</strong> &nbsp;{selectedData.owner_name}
                                      </p>
                                    </div>
                                    <div className="col-md-6">
                                      <p className="d-flex align-items-center">
                                    ...
                                    <div className="col-md-6">
                                      <p className="d-flex align-items-center">
                                        ...
                                        <strong>Aadhar Number:</strong> &nbsp;{selectedData.addhar_number}
                                      </p>
                                    </div>
                                    <div className="col-md-6">
                                      <p className="d-flex align-items-center">
                                        <i className="bi bi-credit-card text-warning me-2"></i>
                                        <strong>Driving Licence:</strong> &nbsp;{selectedData.owner_dl}
                                      </p>
                                    </div>
                                    <div className="col-md-12">
                                      <p className="d-flex align-items-center">
                                        <i className="bi bi-map text-warning me-2"></i>
                                        <strong>Address:</strong> &nbsp;{selectedData.address_line_f} &nbsp;{selectedData.address_line_t} &nbsp;{selectedData.city} &nbsp;{selectedData.state} &nbsp; {selectedData.pin_code}
                                      </p>
                                    </div>
                                  </div>
                                </div>
                    ...
                    <Card className="shadow-sm hover-shadow mt-3">
                      <Card.Header className="bg-warning text-white">
                        <h6 className='card-title text-light m-0'>Driver Information</h6>
                      </Card.Header>
                      <Card.Body>
                        <div className="row">
                          <div className="col-md-3 text-center">
                            ...
                            <div className="row">
                              <div className="col-md-6">
                                <p className="d-flex align-items-center">
                                  ...
                                  <strong>Name:</strong> &nbsp;{selectedData.driver_name}
                                </p>
                              </div>
                              <div className="col-md-6">
                                <p className="d-flex align-items-center">
                                  <i className="bi bi-telephone text-purple me-2"></i>
                                  <strong>Phone:</strong> &nbsp;{selectedData.d_phone}
                                </p>
                              </div>
                              <div className="col-md-6">
                                <p className="d-flex align-items-center">
                                  <i className="bi bi-credit-card text-purple me-2"></i>
                                  <strong>Aadhar Number:</strong> &nbsp;{selectedData.d_addhar_number}
                                </p>
                              </div>
                              <div className="col-md-6">
                                <p className="d-flex align-items-center">
                                  <i className="bi bi-credit-card text-warning me-2"></i>
                                  <strong>Driving Licence:</strong> &nbsp;{selectedData.d_dl_number}
                                </p>
                              </div>
                              <div className="col-md-12">
                                <p className="d-flex align-items-center">
                                  <i className="bi bi-map text-purple me-2"></i>
                                  <strong>Address:</strong> &nbsp;{selectedData.d_address_line_f} &nbsp;{selectedData.d_address_line_t} &nbsp;{selectedData.d_city} &nbsp;{selectedData.d_state} &nbsp;{selectedData.d_pin_code}
                                </p>
                              </div>
                            </div>
                          </div>
                ...
                {showModal && (
                    <div className="modal fade show d-block" tabIndex="-1" aria-labelledby="routeModalLabel" aria-hidden="true" style={{ backgroundColor: 'rgba(0, 0, 0, 0.5)' }}>
                          ...
                          <form onSubmit={handleSubmit}>
                            <div className="modal-body">
                              <div className="mb-3">
                                ...
                                <select className="form-select" name="e_ricksaw_route" onChange={handleInputChange} value={formData.e_ricksaw_route}>
                              ...
                              <div className="mb-3">
                                <label htmlFor="qrSelect" className="form-label">Assign QR</label>
                                <select className="form-select" name="qr_assing_statu" onChange={handleInputChange} value={formData.qr_assing_statu}>
                              ...
                              {formData.qr_assing_statu === '1' && (
                                <div className="mb-3">
                                  <label htmlFor="qrID" className="form-label">Enter QR Code</label>
                                  <input
                                    type="text"
